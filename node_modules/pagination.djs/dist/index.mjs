import { ButtonStyle, EmbedBuilder, ActionRowBuilder, normalizeArray, ButtonBuilder, MessageFlags, BaseInteraction, Message, ComponentType, MessageComponentInteraction } from 'discord.js';
...
var _PaginationEmbed = class _PaginationEmbed extends EmbedBuilder {
  /**
...
${this.postDescription}`
  ...
  _readyPayloads() {
    ...
    this.payload.flags = this.ephemeral ? MessageFlags.Ephemeral : void 0;
